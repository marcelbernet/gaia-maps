...
const App: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 min-h-screen h-screen w-full bg-gray-100 flex flex-col overflow-hidden">
      ...
      <div style={{ width: '100%', display: 'flex', justifyContent: 'center', position: 'relative', zIndex: 101 }}>
        {error && (
          <div className="date-time-widget-error" style={{ position: 'absolute', top: 0, left: 0, right: 0, margin: '0 auto' }}>
            <span style={{ flex: 1, textAlign: 'left', minWidth: 0 }}>{error || ' '}</span>
            <button
              type="button"
      ...
      <div className="absolute left-1/2 -translate-x-1/2 z-50 w-full max-w-xl max-w-[95vw] flex flex-col items-center" style={{ bottom: '12.5vh', position: 'absolute' }}>
        <div className={
